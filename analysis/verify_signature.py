...
# Retain existing import per requirements
try:
    from signature import publisher
except ImportError:
    try:
        import analysis.publisher as publisher
    except ImportError:
        import publisher
...
def _extract_publisher_name(raw_publisher: str) -> str:
    ...
    # Match CN="Value" or CN=Value stopping at unquoted comma or end of string
    ...
    # Fallback to original parsing heuristic
