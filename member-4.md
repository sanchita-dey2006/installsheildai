...
### 🔹 পরিবর্তন ২: ReportLab 2-Pass Vector PDF Report Generator (`ai/pdf_generator.py`)
* **সমস্যা**: প্রাথমিক অবস্থায় জেনারেট হওয়া PDF গুলোর পেজ নম্বর বা ডিজাইন লেআউট স্ট্যান্ডার্ড ছিল না।
* **সমাধান & কেন করা হয়েছে**: ReportLab 5.0 ব্যবহার করে ২-পাস `NumberedCanvas` চালিত প্রাতিষ্ঠানিক সিকিউরিটি রিপোর্ট তৈরি করা হয়েছে।
...
3. **High-Resolution Vector PDF Download**: সুন্দর লেআউটে ভেক্টর PDF ফাইল সরাসরি ডাউনলোড হয়।
